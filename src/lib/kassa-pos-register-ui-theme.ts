...
export function createKassaPosRegisterUiTheme(dark: boolean): KassaRegisterUiTheme {
  ...
  return {
    ...
    productTileFooterBar: 'border-[#14110e] bg-[#161310]',
    sidebarBg: KASSA_POS_MENU_TRANSPARENT_CLASS,
    ringOffset: 'ring-offset-[#161310]',
    tablePickerPanel: `absolute left-0 right-0 top-full mt-1 z-50 ${KASSA_POS_BTN_SHAPE} shadow-lg border border-[#14110e] bg-[#161310] overflow-hidden`,
    tablePickerHeader: 'border-b border-[#14110e] bg-[#161310]',
    tablePickerFooterBar: 'p-2 border-t border-[#14110e] bg-[#161310] flex gap-2',
