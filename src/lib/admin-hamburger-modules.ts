    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '',
          label: 'Boekhouding',
          labelKey: itemLabelKey('sm_inst_boekhouding'),
          href: `${baseUrl}/boekhouding`,
        },
        {
          id: 'sm_abonnement',
          icon: '',
...
export function filterHamburgerModulesForAccess(
  ...
  /** Account altijd voor kassa-tenants; reserveringspakket volgt toggles (geen vast abonnement). */
