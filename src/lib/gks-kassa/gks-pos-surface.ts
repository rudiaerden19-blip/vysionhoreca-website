...
/** Geselecteerd — zwarte lift + blauwe gloed + dunne top-rand (metaal). */
...
/** Afrekenen — zelfde zwarte lift; blauwe gloed iets zachter dan geselecteerde knoppen. */
...
/** Footer Afrekenen — signature-stap; minder blauwe halo dan Ter plaatse/Menu. */
