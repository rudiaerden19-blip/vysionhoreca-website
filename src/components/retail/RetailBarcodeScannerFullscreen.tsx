...
export function RetailBarcodeScannerFullscreen({
  ...
  return createPortal(
    <>
      <div
        className="pointer-events-none fixed inset-0 z-[810] flex flex-col"
        aria-hidden
      >
        ...
        <p className="absolute inset-x-4 bottom-[max(1.25rem,env(safe-area-inset-bottom))] text-center text-sm font-semibold leading-snug text-white drop-shadow-[0_2px_6px_rgba(0,0,0,0.95)] sm:text-base">
          {hint}
        </p>
      </div>
