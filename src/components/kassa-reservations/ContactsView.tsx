...
export function ContactsView({
  ...
  const [noShowSaving, setNoShowSaving] = useState<string | null>(null)
      ...
      {selectedTotal > 0 && (
        <div className="flex flex-wrap items-center gap-3 rounded-xl border border-[#bcc8dc] bg-[#f2f5fa] px-4 py-3 text-sm">
          ...
          <button
            ...
            className="flex min-h-[44px] items-center gap-2 rounded-xl bg-black px-4 py-2 font-bold text-white shadow-sm transition-colors hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50 touch-manipulation"
          >
            {rk('promoEmailBulk')}
              ...
              return (
                ...
                >
                    ...
                    {guest.email ? (
                      <>
                        ...
                        <button
                          ...
                          className="shrink-0 rounded-lg bg-black px-2.5 py-1.5 text-xs font-bold text-white shadow-sm transition-colors hover:bg-gray-800 active:bg-gray-900 touch-manipulation"
                  ...
                  <button
                    ...
                    disabled={saving}
                    onClick={async () => {
                      setNoShowSaving(guest.id)
                      try {
                        await onToggleNoShow(guest)
                      } finally {
                        setNoShowSaving(null)
                      }
                    }}
