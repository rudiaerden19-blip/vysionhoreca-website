...
import RetailLandingHero from './RetailLandingHero'
  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          {t('retailSite.gratisWebsite.title')}
        </h2>
        <p className="text-sm sm:text-base text-gray-600 leading-relaxed mb-6">
          {t('retailSite.gratisWebsite.body')}
        </p>
        <div className="flex justify-center">
          ...
          >
            {t('retailSite.gratisWebsite.cta')}
          </a>
        </div>
      </div>
    </section>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-24 items-stretch">
                ...
                <div className="min-w-0 pt-0.5">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 leading-snug">
                    {key === 'foodtrucksOffline'
                      ? t('retailSite.offline.title')
                      : t(`whyVysion.${key}.title`)}
                  </h3>
                  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                    {key === 'foodtrucksOffline'
                      ? t('retailSite.offline.body')
          ...
          <div className="order-1 lg:order-2 relative flex w-full flex-col gap-8 self-start sm:gap-10 lg:gap-12 lg:pl-6 xl:pl-10">
            ...
            <MarketingStartAndDemoButtons demoHref="/retail#contact" className="relative z-10 w-full shrink-0 lg:justify-start lg:px-0" />
          </div>
        </div>
      </div>
    </section>
  ...
  return (
    <section ref={sectionRef} className="py-28 sm:py-36 bg-[#e3e3e3] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          <MarketingStartAndDemoButtons demoHref="/retail#contact" />
        </div>
      </div>
    </section>
  )
  ...
  return (
    <section id="prijzen" className="py-28 sm:py-36 lg:py-40 bg-[#e3e3e3] relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <MarketingStartAndDemoButtons demoHref="/retail#contact" className="mt-12 sm:mt-14" />
      </div>
      {modulesModal}
      {retailModal}
    </section>
...
const TABLE_KIOSK_SLIDES = [
  '/images/hardware/hardware-vm20-sunmi.png',
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
          <div className="w-full max-w-md sm:max-w-lg lg:max-w-xl mx-auto lg:mx-0 rounded-3xl bg-[#e3e3e3] p-3 sm:p-5 lg:p-6 shadow-home-image ring-1 ring-black/[0.06]">
            <div
              ...
              aria-label={t('retailSite.kiosk.carouselAria')}
              tabIndex={0}
              onKeyDown={(e) => {
                if (e.key === 'ArrowLeft') {
                  e.preventDefault()
            ...
            >
              <button
                ...
                aria-label={`${t('subscriptionsPage.enlargeImageHint')}: ${t('retailSite.kiosk.imageAlt')} (${kioskSlide + 1} / ${kioskCount})`}
              >
                <Image
                  src={TABLE_KIOSK_SLIDES[kioskSlide]}
                  alt={`${t('retailSite.kiosk.imageAlt')} (${kioskSlide + 1} / ${kioskCount})`}
                  fill
            ...
            <p className="mt-3 text-center text-sm text-gray-600">{t('retailSite.kiosk.clickToEnlarge')}</p>
          </div>
          ...
          <div className="flex flex-col justify-center py-2 lg:py-4">
            ...
            >
              {t('retailSite.kiosk.subtitle')}
            </h2>
            <p className="text-gray-700 text-base sm:text-lg leading-relaxed mb-10">{t('retailSite.kiosk.body')}</p>
            <ul className="space-y-4">
              {featureKeys.map((key) => (
                <li key={key} className="flex items-start gap-3">
                  ...
                  <span className="text-gray-800 text-base sm:text-lg leading-snug">{t(`retailSite.kiosk.features.${key}`)}</span>
                </li>
              ))}
            </ul>
            <MarketingStartAndDemoButtons demoHref="/retail#contact" className="mt-[calc(2.5rem+2cm)]" />
          </div>
        </div>
      </div>
        ...
        createPortal(
          ...
          >
            ...
            >
              ...
              <img
                src={TABLE_KIOSK_SLIDES[kioskSlide]}
                alt={`${t('ui.lightboxImageAlt')}: ${t('retailSite.kiosk.imageAlt')} (${kioskSlide + 1} / ${kioskCount})`}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div>
            ...
            <MarketingStartAndDemoButtons demoHref="/retail#contact" className="mb-8 justify-start sm:justify-start" layout="stack" fullWidth={false} />
          </div>
