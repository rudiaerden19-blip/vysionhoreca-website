        ...
        <div className="w-full max-w-md text-center">
          ...
          <div className="p-8 bg-green-500/10 border border-green-500/30 rounded-xl">
            ...
            <p className="text-gray-300 mb-6">
              Je emailadres is succesvol bevestigd. Download nu de app!
            </p>
            
            {/* Download App Buttons */}
            <div className="space-y-3 mb-6">
              <a
                href="https://testflight.apple.com/join/dFSQPBK3"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 w-full bg-black hover:bg-gray-900 text-white p-4 rounded-xl transition-all border border-gray-700"
              >
