...
const PRO_CARD_IMAGE = '/images/abonnement-vysion-pro.png'
...
export default function AbonnementenPage() {
  ...
  return (
    <div className="min-h-screen bg-[#e3e3e3]">
      ...
      <section className="pt-28 sm:pt-32 pb-8 bg-[#e3e3e3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-3">{t('subscriptionsPage.title')}</h1>
          <p className="text-gray-600 text-sm sm:text-base font-medium">{t('pricing.exclVat')}</p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-start">
            <div className="space-y-6">
              ...
              <div className="rounded-2xl overflow-hidden border border-gray-200 bg-white shadow-sm">
                <Image
                  src={PRO_CARD_IMAGE}
                  alt={t('subscriptionsPage.vysionProImageAlt')}
                  width={800}
                  height={1200}
            ...
            <div className="lg:pt-2">
              ...
              <p className="text-gray-500 text-sm font-medium">{t('pricing.trialInfo')}</p>
              <a
                href="/prijzen"
