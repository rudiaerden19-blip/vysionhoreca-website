...
export const metadata: Metadata = {
  ...
  description:
    "Prijzen Vysion kassa's: kassa (POS), online bestelplatform en kassahardware in transparante abonnementen. Starter en Pro, maandelijks of jaarlijks — 14 dagen gratis proberen.",
  keywords: [
