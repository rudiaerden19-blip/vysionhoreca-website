...
const navigation = [
  ...
  { name: 'Bestellingen', href: '/dashboard/bestellingen', icon: 'orders' },
  { name: 'Klanten', href: '/dashboard/klanten', icon: 'customers' },
  { name: 'Producten', href: '/dashboard/producten', icon: 'products' },
  { name: 'Rapporten', href: '/dashboard/rapporten', icon: 'reports' },
  { name: 'Analyse', href: '/dashboard/analyse', icon: 'analytics' },
