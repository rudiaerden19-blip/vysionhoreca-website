...
const legacyTranslations: Record<string, Record<string, string>> = {
  ...
  fr: {
    ...
    perMonth: '/mois',
    starter: 'Plateforme de commande en ligne',
  ...
  de: {
    ...
    perMonth: '/Monat',
    starter: 'Online-Bestellplattform',
  ...
  es: {
    ...
    perMonth: '/mes',
    starter: 'Plataforma de pedidos online',
  ...
  it: {
    ...
    perMonth: '/mese',
    starter: 'Piattaforma ordini online',
  ...
  ar: {
    ...
    perMonth: '/شهر',
    starter: 'منصة الطلب عبر الإنترنت',
