-- =============================================================================
-- VYSION KASSA: personeelklok + verkoop per medewerker (ALLE tenants)
-- ÉÉN bestand met alle wijzigingen — plakken in Supabase SQL Editor en uitvoeren.
-- Vereist: tabellen staff, tenant_settings, orders bestaan al.
-- =============================================================================
