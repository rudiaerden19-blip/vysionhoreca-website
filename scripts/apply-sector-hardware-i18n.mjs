...
const SECTOR_PAGES = {
  nl: {
    breadcrumb: 'Sectoren',
    hardwareBeest: {
      title: "Intel i7 dual-screen: 'Het Beest'",
      specProcessor: '🚀 Processor: Intel i7 Core (ongeëvenaarde snelheid)',
      specMemory: '🧠 Geheugen: 16 GB RAM + 128 GB SSD',
    ...
    bakkerij: {
      h1: 'Snelste Kassasysteem voor Bakkers | i7 Kracht & 9 Talen | Vysion',
      intro:
        "Specifieke kassa-layout voor bakkers: Intel i7 (‘Het Beest’) voor pieksnelheid in de ochtend, 9 talen voor je team, en na 24 maanden is de hardware van jou — dé keuze als je een sterk kassasysteem België en Nederland zoekt.",
      body1:
      ...
      ownership24: 'Stop met huren. Na 24 maanden is deze i7 kassa 100% jouw eigendom.',
    },
    cafe: {
      h1: 'Horeca Kassa voor Cafés | i7 Dual-Screen & 9 Talen | Vysion',
      intro:
        'Café-ritme vraagt een razendsnelle kassa: i7-hardware (‘Het Beest’), 9 talen voor meertalig personeel en overzicht op je marge — de horeca kassa voor brasserie, koffiebar en lunchroom.',
      body1:
      ...
      body2:
        'Minder tikken, minder fouten, meer bedieningen per uur. Probeer Vysion gratis en ervaar i7-kracht met duidelijke voorwaarden en eigendom na 24 maanden.',
      imageAlt: 'Vysion kassa layout voor café en brasserie',
      cta: 'Start gratis',
      ownership24: 'Stop met huren. Na 24 maanden is deze i7 kassa 100% jouw eigendom.',
    },
    frituur: {
      h1: 'Frituur Kassa | Snelste i7 Checkout | Vysion',
      intro:
        'Frituurpieken en festivals: jouw kassa moet mee. Intel i7 (‘Het Beest’), dubbel scherm voor de klant, 9 talen voor je team — gebouwd voor drukte, olie en tempo.',
      body1:
    ...
    kebab: {
      h1: 'Kebab & Broodjesbar Kassa | i7 Kracht | Vysion',
      intro:
        'Late-night druk en broodjes in het kwadraat: met i7-hardware (‘Het Beest’) en 9 talen blijft je team snel — de kassa voor kebab, döner en broodjesbar.',
      body1:
      ...
      body2:
        'Minder stress aan de toonbank, meer controle op omzet. Probeer gratis en ontdek waarom ondernemers kiezen voor i7 in plaats van traag materiaal.',
    ...
    kapper: {
      ...
      intro:
        'Geef je salon de upgrade die het verdient: professionele i7-kassa (‘Het Beest’), eenvoudig afrekenen, 9 talen voor je team, en na 24 maanden is de hardware van jou.',
      body1:
    ...
    retail: {
      h1: "Retail Kassa & Voorraadbeheer | Het i7 'Beest' voor Winkels | Vysion",
      intro:
        'Beheer je winkelvoorraad op krachtige i7-hardware (16 GB RAM), met touchscreen POS en gratis website-integratie — retail kassa die meegroeit met je zaak.',
      body1:
  ...
  en: {
    breadcrumb: 'Sectors',
    hardwareBeest: {
      title: "Vysion i7 dual-screen: 'The Beast'",
      specProcessor: '🚀 Processor: Intel i7 Core (unmatched speed)',
      specMemory: '🧠 Memory: 16 GB RAM + 128 GB SSD',
    ...
    bakkerij: {
      h1: 'Fastest POS for Bakeries | i7 Power & 9 Languages | Vysion',
      intro:
        "Bakery-focused checkout: Intel i7 ('The Beast') for morning rush speed, 9 languages for your team, and you own the hardware after 24 months — the POS Belgium and the Netherlands rely on.",
      body1:
      ...
      ownership24: 'Stop renting. After 24 months, this i7 POS is 100% yours.',
    },
    cafe: {
      h1: 'Hospitality POS for Cafés | i7 Dual-Screen & 9 Languages | Vysion',
      intro:
        'Café pace demands a fast checkout: i7 hardware, 9 languages for multilingual crews, and margin insight — the hospitality POS for brasseries, coffee bars and lunch spots.',
      body1:
      ...
      body2:
        'Fewer taps, fewer errors, more covers per hour. Try Vysion free and feel i7 power with clear terms and ownership after 24 months.',
      imageAlt: 'Vysion POS layout for café and brasserie',
      cta: 'Start free',
      ownership24: 'Stop renting. After 24 months, this i7 POS is 100% yours.',
    },
    frituur: {
      h1: 'Chip Shop POS | Fastest i7 Checkout | Vysion',
      intro:
        'Chip shop peaks and events: your till must keep up. Intel i7, dual screen for customers, 9 languages for your team — built for heat, queues and speed.',
      body1:
    ...
    kebab: {
      h1: 'Kebab & Sandwich Bar POS | i7 Power | Vysion',
      intro:
        'Late-night volume and sandwiches at speed: i7 hardware and 9 languages keep your crew fast — the POS for kebab, döner and sandwich bars.',
      body1:
      ...
      body2:
        'Less stress at the counter, more control on revenue. Try free and see why operators pick i7 over sluggish kit.',
    ...
    kapper: {
      ...
      intro:
        'Give your salon the upgrade: professional i7 POS, smooth payments, 9 languages for your team, and you own the hardware after 24 months.',
      body1:
    ...
    retail: {
      h1: "Retail POS & Stock Control | The i7 'Beast' for Shops | Vysion",
      intro:
        'Run stock on powerful i7 hardware (16 GB RAM), touchscreen POS and free website integration — retail checkout that scales with you.',
      body1:
  ...
  de: {
    breadcrumb: 'Branchen',
    hardwareBeest: {
      title: "Vysion i7 Dual-Screen: 'Das Biest'",
      specProcessor: '🚀 Prozessor: Intel i7 Core (unglaubliche Geschwindigkeit)',
      specMemory: '🧠 Speicher: 16 GB RAM + 128 GB SSD',
    ...
    bakkerij: {
      h1: 'Schnellstes Kassensystem für Bäckereien | i7 & 9 Sprachen | Vysion',
      intro:
        'Kassenlayout für Bäcker: Intel i7 für Morgenspitzen, 9 Sprachen fürs Team, nach 24 Monaten gehört die Hardware Ihnen — das Kassensystem für Belgien und die Niederlande.',
      body1:
      ...
      ownership24: 'Schluss mit Mieten. Nach 24 Monaten ist diese i7-Kasse zu 100 % Ihr Eigentum.',
    },
    cafe: {
      h1: 'Gastronomie-Kasse für Cafés | i7 Dual-Screen & 9 Sprachen | Vysion',
      intro:
        'Café-Takt verlangt eine schnelle Kasse: i7-Hardware, 9 Sprachen für mehrsprachige Teams, Margen im Blick — die Gastro-Kasse für Brasserie, Coffee-Shop und Lunch.',
      body1:
      ...
      body2:
        'Weniger Tippen, weniger Fehler, mehr Umsatz pro Stunde. Vysion kostenlos testen — i7-Leistung mit klaren Konditionen und Eigentum nach 24 Monaten.',
      imageAlt: 'Vysion Kassenlayout für Café und Brasserie',
      cta: 'Kostenlos starten',
      ownership24: 'Schluss mit Mieten. Nach 24 Monaten ist diese i7-Kasse zu 100 % Ihr Eigentum.',
    },
    frituur: {
      h1: 'Imbiss-Kasse | Schnellste i7-Kasse | Vysion',
      intro:
        'Imbiss-Spitzen und Events: Ihre Kasse muss mithalten. Intel i7, Doppeldisplay für Gäste, 9 Sprachen fürs Team — für Stress, Öl und Tempo gebaut.',
      body1:
    ...
    kebab: {
      h1: 'Kebab- & Sandwichbar-Kasse | i7 Power | Vysion',
      intro:
        'Spätschicht und hohe Stückzahlen: i7-Hardware und 9 Sprachen halten Ihr Team schnell — die Kasse für Kebab, Döner und Sandwichbars.',
      body1:
      ...
      body2:
        'Weniger Stress an der Theke, mehr Kontrolle über Umsatz. Kostenlos testen und sehen, warum Betreiber i7 wählen.',
    ...
    kapper: {
      ...
      intro:
        'Upgrade für Ihren Salon: professionelle i7-Kasse, reibungslose Zahlungen, 9 Sprachen fürs Team, nach 24 Monaten gehört die Hardware Ihnen.',
      body1:
    ...
    retail: {
      h1: "Retail-Kasse & Lager | Das i7 'Biest' für Shops | Vysion",
      intro:
        'Lagerverwaltung auf starker i7-Hardware (16 GB RAM), Touchscreen-POS und kostenlose Website-Integration — Retail-Kasse, die mitwächst.',
      body1:
  ...
  fr: {
    breadcrumb: 'Secteurs',
    hardwareBeest: {
      title: "Vysion i7 double écran : « La Bête »",
      specProcessor: '🚀 Processeur : Intel i7 Core (vitesse inégalée)',
      specMemory: '🧠 Mémoire : 16 Go RAM + 128 Go SSD',
    ...
    bakkerij: {
      h1: 'Caisse la plus rapide pour boulangers | i7 & 9 langues | Vysion',
      intro:
        'Mise en caisse boulangerie : Intel i7 pour les pics du matin, 9 langues, propriété du matériel après 24 mois — le système de caisse Belgique et Pays-Bas.',
      body1:
      ...
      ownership24: 'Arrêtez de louer. Après 24 mois, cette caisse i7 est 100 % à vous.',
    },
    cafe: {
      h1: 'Caisse restauration pour cafés | i7 double écran & 9 langues | Vysion',
      intro:
        'Rythme café = caisse rapide : matériel i7, 9 langues pour équipes multilingues, vision des marges — la caisse pour brasserie, coffee shop et déjeuner.',
      body1:
      ...
      body2:
        'Moins de saisies, moins d’erreurs, plus de couverts. Essayez Vysion gratuitement — puissance i7 et propriété après 24 mois.',
      imageAlt: 'Mise en caisse Vysion pour café et brasserie',
      cta: 'Commencer gratuitement',
      ownership24: 'Arrêtez de louer. Après 24 mois, cette caisse i7 est 100 % à vous.',
    },
    frituur: {
      h1: 'Caisse friterie | Checkout i7 le plus rapide | Vysion',
      intro:
        'Pics friterie et événements : votre caisse doit suivre. Intel i7, double écran client, 9 langues — pour la file, l’huile et le tempo.',
      body1:
    ...
    kebab: {
      h1: 'Caisse kebab & sandwicherie | Puissance i7 | Vysion',
      intro:
        'Soirées chargées et sandwichs à la chaîne : i7 et 9 langues gardent l’équipe rapide — la caisse kebab, döner et sandwicherie.',
      body1:
        'Salle, à emporter et livraison sans chaos. Flux de caisse rapide avec tickets clairs — système Belgique pour fort débit.',
      body2:
        'Moins de stress au comptoir, plus de contrôle sur le CA. Essayez gratuitement et voyez pourquoi les pros choisissent l’i7.',
    ...
    kapper: {
      ...
      intro:
        'La caisse pro i7, paiements fluides, 9 langues pour l’équipe, propriété du matériel après 24 mois — l’upgrade pour votre salon.',
      body1:
    ...
    retail: {
      h1: "Caisse retail & stock | L'i7 « Bête » pour magasins | Vysion",
      intro:
        'Stock sur i7 (16 Go RAM), POS tactile et intégration site gratuite — la caisse retail qui grandit avec vous.',
      body1:
  ...
  es: {
    breadcrumb: 'Sectores',
    hardwareBeest: {
      title: "Vysion i7 doble pantalla: 'La Bestia'",
      specProcessor: '🚀 Procesador: Intel i7 Core (velocidad sin igual)',
      specMemory: '🧠 Memoria: 16 GB RAM + 128 GB SSD',
    ...
    bakkerij: {
      h1: 'TPV más rápido para panaderías | i7 y 9 idiomas | Vysion',
      intro:
        'Caja pensada para panadería: Intel i7 para el pico matinal, 9 idiomas para el equipo, propiedad del hardware a los 24 meses — el TPV Bélgica y Países Bajos.',
      body1:
      ...
      ownership24: 'Deja de alquilar. A los 24 meses, este TPV i7 es 100 % tuyo.',
    },
    cafe: {
      h1: 'TPV hostelería para cafeterías | i7 doble pantalla y 9 idiomas | Vysion',
      intro:
        'El ritmo del café exige caja rápida: hardware i7, 9 idiomas para equipos multilingües y control de márgenes — TPV para brasserie, bar de café y lunch.',
      body1:
      ...
      body2:
        'Menos toques, menos errores, más cubiertos. Prueba Vysion gratis — potencia i7 y propiedad a los 24 meses.',
      imageAlt: 'Layout Vysion TPV para café y brasserie',
      cta: 'Empezar gratis',
      ownership24: 'Deja de alquilar. A los 24 meses, este TPV i7 es 100 % tuyo.',
    },
    frituur: {
      h1: 'TPV freiduría | Checkout i7 más rápido | Vysion',
      intro:
        'Picos de freiduría y eventos: tu caja debe aguantar. Intel i7, doble pantalla para el cliente, 9 idiomas — para colas, aceite y ritmo.',
      body1:
    ...
    kebab: {
      h1: 'TPV kebab y bocatería | Potencia i7 | Vysion',
      intro:
        'Noches intensas y bocadillos al máximo: hardware i7 y 9 idiomas mantienen al equipo rápido — TPV para kebab, döner y bocatería.',
      body1:
        'Sala, recogida y reparto sin caos. Flujo de caja rápido con tickets claros — TPV hostelería Bélgica para alto rendimiento.',
      body2:
        'Menos estrés en mostrador, más control de ingresos. Prueba gratis y ve por qué eligen i7.',
    ...
    kapper: {
      ...
      intro:
        'TPV i7 profesional, pagos fluidos, 9 idiomas para el equipo, propiedad del hardware a los 24 meses — la mejora para tu salón.',
      body1:
    ...
    retail: {
      h1: "TPV retail y stock | El i7 'Bestia' para tiendas | Vysion",
      intro:
        'Stock en i7 (16 GB RAM), TPV táctil e integración web gratis — retail que crece contigo.',
      body1:
  ...
  it: {
    breadcrumb: 'Settori',
    hardwareBeest: {
      title: "Vysion i7 dual-screen: 'La Bestia'",
      specProcessor: '🚀 Processore: Intel i7 Core (velocità senza pari)',
      specMemory: '🧠 Memoria: 16 GB RAM + 128 GB SSD',
    ...
    bakkerij: {
      h1: 'Cassa più veloce per panetterie | i7 e 9 lingue | Vysion',
      intro:
        'Layout cassa per panetteria: Intel i7 per il picco mattutino, 9 lingue per il team, proprietà hardware dopo 24 mesi — il POS Belgio e Paesi Bassi.',
      body1:
      ...
      ownership24: 'Smetti di noleggiare. Dopo 24 mesi questa cassa i7 è 100% tua.',
    },
    cafe: {
      h1: 'Cassa ristorazione per caffè | i7 dual-screen e 9 lingue | Vysion',
      intro:
        'Il ritmo del bar chiede cassa veloce: hardware i7, 9 lingue per team multilingue, margini sotto controllo — POS per brasserie, coffee bar e pranzo.',
      body1:
      ...
      body2:
        'Meno tocchi, meno errori, più coperti. Prova Vysion gratis — potenza i7 e proprietà dopo 24 mesi.',
      imageAlt: 'Layout cassa Vysion per caffè e brasserie',
      cta: 'Inizia gratis',
      ownership24: 'Smetti di noleggiare. Dopo 24 mesi questa cassa i7 è 100% tua.',
    },
    frituur: {
      h1: 'Cassa friggitoria | Checkout i7 più veloce | Vysion',
      intro:
        'Picchi da friggitoria ed eventi: la cassa deve reggere. Intel i7, doppio schermo cliente, 9 lingue — per code, olio e ritmo.',
      body1:
    ...
    kebab: {
      h1: 'Cassa kebab & panineria | Potenza i7 | Vysion',
      intro:
        'Sere piene e panini al massimo: i7 e 9 lingue tengono il team veloce — POS per kebab, döner e panineria.',
      body1:
        'Sala, asporto e consegna senza caos. Flusso cassa rapido con scontrini chiari — POS Belgio per alto throughput.',
      body2:
        'Meno stress al bancone, più controllo sui ricavi. Prova gratis e scopri perché si sceglie i7.',
    ...
    kapper: {
      ...
      intro:
        'Cassa i7 professionale, pagamenti fluidi, 9 lingue per il team, proprietà hardware dopo 24 mesi — l’upgrade per il tuo salone.',
      body1:
    ...
    retail: {
      h1: "Cassa retail & magazzino | L'i7 'Bestia' per negozi | Vysion",
      intro:
        'Magazzino su i7 (16 GB RAM), POS touch e integrazione web gratuita — retail che scala con te.',
      body1:
  ...
  ja: {
    breadcrumb: '業種',
    hardwareBeest: {
      title: 'Vysion i7 デュアル画面「The Beast」',
      specProcessor: '🚀 プロセッサ: Intel i7 Core（圧倒的な速さ）',
      specMemory: '🧠 メモリ: 16GB RAM + 128GB SSD',
    ...
    bakkerij: {
      h1: 'ベーカリー向け最速POS | i7 & 9言語 | Vysion',
      intro:
        '朝のピークに強いIntel i7、チーム向け9言語、24か月後にハードがあなたの資産に — ベルギー・オランダの店舗向けPOS。',
      body1:
      ...
      cta: '無料で開始 — 14日間トライアル',
      ownership24: 'レンタルをやめましょう。24か月後、このi7レジは100％あなたの資産です。',
    },
    cafe: {
      h1: 'カフェ向け飲食POS | i7デュアル画面 & 9言語 | Vysion',
      intro:
        'カフェの忙しさに合わせた高速レジ：i7、多言語チーム向け9言語、粗利の可視化 — ブラッスリー・コーヒーバー向け。',
      body1:
        '朝のラッシュもテラス席も、最速の会計フロー。店内・テイクアウト・オンライン注文を一元化 — ベルギーのカフェに最適。',
      body2:
        'タップを減らし、ミスを減らし、回転を上げる。無料で試してi7の体感と24か月後の所有を。',
      imageAlt: 'カフェ・ブラッスリー向けVysion POSレイアウト',
      cta: '無料で開始',
      ownership24: 'レンタルをやめましょう。24か月後、このi7レジは100％あなたの資産です。',
    },
    frituur: {
      h1: 'フライショップ向けPOS | 最速i7会計 | Vysion',
      intro:
        'ピークとイベントでも止まらないレジ：Intel i7、客向けデュアル画面、9言語 — 行列とスピード向け。',
      body1:
    ...
    kebab: {
      h1: 'ケバブ・サンドイッチバー向けPOS | i7パワー | Vysion',
      intro:
        '深夜の忙しさと大量オーダーに：i7と9言語でスタッフを高速に — ケバブ・ドネル・サンドイッチバー向け。',
      body1:
        '店内・テイクアウト・デリバリーを混乱なく。明確なチケットで高速会計 — 高回転飲食向けベルギーPOS。',
      body2:
        'レジ前のストレスを減らし売上を把握。無料体験でi7が選ばれる理由を。',
    ...
    kapper: {
      ...
      intro:
        'プロ仕様のi7レジ、スムーズな決済、チーム向け9言語、24か月後にハード所有 — サロンのアップグレード。',
      body1:
    ...
    retail: {
      h1: '小売POS & 在庫 | 店舗向けi7「Beast」| Vysion',
      intro:
        'i7（16GB RAM）で在庫管理、タッチPOS、無料サイト連携 — 店とともに伸びる小売レジ。',
      body1:
  ...
  zh: {
    breadcrumb: '行业方案',
    hardwareBeest: {
      title: 'Vysion i7 双屏收银机「猛兽」',
      specProcessor: '🚀 处理器：Intel i7 核心（极速体验）',
      specMemory: '🧠 内存：16GB RAM + 128GB SSD',
    ...
    bakkerij: {
      h1: '面包房最快收银系统 | i7 性能与 9 种语言 | Vysion',
      intro:
        '面向面包房的布局：Intel i7 应对早高峰，团队支持 9 种语言，24 个月后硬件归您 — 比利时与荷兰门店之选。',
      body1:
      ...
      cta: '免费开始 — 14 天试用',
      ownership24: '别再只租不买。24 个月后，这台 i7 收银机 100% 归您所有。',
    },
    cafe: {
      h1: '咖啡馆餐饮收银 | i7 双屏与 9 种语言 | Vysion',
      intro:
        '咖啡馆节奏需要更快收银：i7 硬件、多语言团队的 9 种语言、毛利一目了然 — 适用于餐吧、咖啡吧与简餐。',
      body1:
        '早高峰或露台繁忙也能保持最快结账。堂食、外带与线上订单同一流程 — 适合比利时高客流咖啡馆。',
      body2:
        '更少点击、更少差错、更高翻台。免费试用 Vysion，感受 i7 性能与 24 个月后设备归属。',
      imageAlt: 'Vysion 咖啡馆与餐吧收银布局',
      cta: '免费开始',
      ownership24: '别再只租不买。24 个月后，这台 i7 收银机 100% 归您所有。',
    },
    frituur: {
      h1: '炸物店收银 | 最快 i7 结账 | Vysion',
      intro:
        '高峰与活动日也要跟得上：Intel i7、面向顾客的双屏、团队 9 种语言 — 为排队与快节奏而设计。',
      body1:
    ...
    kebab: {
      h1: '烤肉/三明治店收银 | i7 强劲性能 | Vysion',
      intro:
        '深夜高峰与大量三明治：i7 与 9 种语言让团队保持高效 — 面向烤肉、 döner 与三明治吧。',
      body1:
        '堂食、自取与外卖不再混乱。小票清晰、结账更快 — 比利时高客流餐饮 POS。',
      body2:
        '减轻柜台压力，更好掌控营收。免费试用，了解为何商家选择 i7。',
    ...
    kapper: {
      ...
      intro:
        '专业 i7 收银、顺畅收款、团队 9 种语言，24 个月后硬件归您 — 为沙龙升级而生。',
      body1:
    ...
    retail: {
      h1: '零售收银与库存 | 门店 i7「猛兽」| Vysion',
      intro:
        '以 i7（16GB RAM）管理库存，触屏 POS 与免费网站对接 — 与门店共同成长的零售收银。',
      body1:
  ...
  ar: {
    breadcrumb: 'القطاعات',
    hardwareBeest: {
      title: 'Vysion i7 بشاشتين — «الوحش»',
      specProcessor: '🚀 المعالج: Intel i7 Core (سرعة استثنائية)',
      specMemory: '🧠 الذاكرة: 16 جيجابايت RAM + 128 جيجابايت SSD',
    ...
    bakkerij: {
      h1: 'أسرع نقاط بيع للمخابز | i7 وتسع لغات | Vysion',
      intro:
        'تخطيط كاشير للمخابز: Intel i7 لذروة الصباح، وتسع لغات للفريق، وامتلاك الجهاز بعد 24 شهرًا — نظام بلجيكا وهولندا.',
      body1:
      ...
      ownership24: 'توقف عن الإيجار. بعد 24 شهرًا، جهاز الكاشير i7 هذا ملكك بالكامل.',
    },
    cafe: {
      h1: 'نقطة بيع للمقاهي | i7 بشاشتين وتسع لغات | Vysion',
      intro:
        'إيقاع المقهى يحتاج كاشيرًا سريعًا: جهاز i7 وتسع لغات للطاقات متعددة اللغات ورؤية الهامش — لمقاهي وبراسيري وغداء.',
      body1:
        'ذروة الصباح أو المقهى الخارجي: أسرع صندوق. الصالة والطلب الخارجي والأونلاين في تدفق واحد — مثالي في بلجيكا.',
      body2:
        'نقرات أقل، أخطاء أقل، تغطية أعلى. جرّب Vysion مجانًا — قوة i7 وامتلاك بعد 24 شهرًا.',
      imageAlt: 'تخطيط كاشير Vysion للمقهى والبراسيري',
      cta: 'ابدأ مجانًا',
      ownership24: 'توقف عن الإيجار. بعد 24 شهرًا، جهاز الكاشير i7 هذا ملكك بالكامل.',
    },
    frituur: {
      h1: 'كاشير المقلي | أسرع دفع i7 | Vysion',
      intro:
        'ذروة المقلي والفعاليات: جهازك يجب أن يلحق. Intel i7 وشاشتان للعميل وتسع لغات — للطوابير والزيت والسرعة.',
      body1:
    ...
    kebab: {
      h1: 'كاشير الكباب وساندوتش بار | قوة i7 | Vysion',
      intro:
        'ليل مزدحم وساندوتش بلا توقف: i7 وتسع لغات تبقي الفريق سريعًا — للكباب والدونر وبار الساندوتش.',
      body1:
        'الصالة والاستلام والتوصيل بلا فوضى. تدفق كاشير سريع بتذاكر واضحة — نقطة بيع بلجيكية بإنتاجية عالية.',
      body2:
        'ضغط أقل على الكاونتر، تحكم أفضل بالإيرادات. جرّب مجانًا واكتشف لماذا يختارون i7.',
    ...
    kapper: {
      ...
      intro:
        'كاشير i7 احترافي، دفع سلس، تسع لغات للفريق، امتلاك الجهاز بعد 24 شهرًا — ترقية لصالونك.',
      body1:
    ...
    retail: {
      h1: 'كاشير التجزئة والمخزون | i7 «الوحش» للمتاجر | Vysion',
      intro:
        'مخزون على i7 (16 جيجابايت RAM)، شاشة لمس وتكامل موقع مجاني — كاشير تجزئة ينمو معك.',
      body1:
