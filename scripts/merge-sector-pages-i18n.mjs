...
const SECTOR_PAGES = {
  nl: {
    ...
    horecaSnack: {
      ...
      intro:
        'Razendsnel bestellen en afrekenen: i7-hardware (‘Het Beest’), 9 talen voor meertalig personeel en grip op je marge — dé horeca kassa voor café, frituur, kebab en broodjesbar.',
      body1:
      ...
      body2:
        'Van broodjesbar tot kebabzaak: houd overzicht op orders, stock en afrekenen. Probeer gratis en ervaar waarom ondernemers kiezen voor i7-kracht in plaats van traag materiaal.',
    ...
    hardwarePlatform: {
      h1: 'Gratis Online Platform & i7 Kassa Hardware | De Vysion Deal',
      intro:
        'Beste platform voor ondernemers: high-end i7-kassa (‘Het Beest’), 44 video-instructies, 9 talen, en na 24 maanden ben jij eigenaar van de hardware — stop met zinloos huren.',
      body1:
        'Combineer online bestelplatform, webshop en kassa in één ecosysteem. Kassa kopen of starten met een helder abonnement: de snelste kassa-ervaring dankzij i7 en SSD.',
      body2:
  ...
  en: {
    ...
    bakkerij: {
      ...
      intro:
        "Bakery-focused checkout layout: Intel i7 ('The Beast') for morning rush speed, 9 languages for your team, and you own the hardware after 24 months — the POS system Belgium and the Netherlands rely on.",
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'Fast order and payment flow: i7 hardware, 9 languages for multilingual crews, margin control — the hospitality POS for cafés, chip shops, kebab and sandwich bars.',
      body1:
      ...
      body2:
        'From sandwich bar to kebab: keep orders, stock and payments in view. Try free and feel why founders pick i7 power over sluggish kit.',
    ...
    hardwarePlatform: {
      h1: 'Free Online Platform & i7 POS Hardware | The Vysion Deal',
      intro:
        'Built for operators: high-end i7 POS, 44 video tutorials, 9 languages, and hardware ownership after 24 months — stop pointless renting.',
      body1:
        'Combine online ordering, webshop and checkout in one ecosystem. Buy a POS or start on a clear plan — fastest checkout with i7 and SSD.',
      body2:
  ...
  de: {
    breadcrumb: 'Branchen',
    bakkerij: {
      h1: 'Schnellstes Kassensystem für Bäckereien | i7-Power & 9 Sprachen | Vysion',
      intro:
        "Bäckerei-Layout: Intel i7 („Das Biest“) für Morgenspitzen, 9 Sprachen fürs Team, nach 24 Monaten gehört die Hardware Ihnen — das Kassensystem Belgien und die Niederlande.",
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'Schnell bestellen und kassieren: i7-Hardware, 9 Sprachen, Margenkontrolle — die Gastro-Kasse für Café, Frittenbude, Kebab und Sandwichbar.',
      body1:
      ...
      body2:
        'Von Sandwich bis Kebab: Bestellungen, Bestand, Zahlung im Blick. Kostenlos testen und i7-Leistung statt langsamer Kassen spüren.',
    ...
    kapper: {
      ...
      intro:
        'Upgrade für Ihren Salon: professionelle i7-Kasse, schnelles Bezahlen, 9 Sprachen, nach 24 Monaten gehört die Hardware Ihnen.',
      body1:
    ...
    retail: {
      h1: "Retail-Kasse & Bestand | Das i7-„Biest“ für Shops | Vysion",
      intro:
        'Bestand auf leistungsstarker i7-Hardware (16 GB RAM), Touchscreen-POS und Website-Integration — Retail-Kasse, die mitwächst.',
      body1:
    ...
    hardwarePlatform: {
      h1: 'Gratis Online-Plattform & i7-Kassenhardware | Das Vysion-Angebot',
      intro:
        'High-End-i7-Kasse, 44 Videoanleitungen, 9 Sprachen, Hardware-Eigentum nach 24 Monaten — aufhören, sinnlos zu mieten.',
      body1:
        'Online-Bestellplattform, Webshop und Kasse vereint. Kasse kaufen oder mit klarem Abo starten — schnellste Kasse dank i7 und SSD.',
      body2:
  ...
  fr: {
    breadcrumb: 'Secteurs',
    bakkerij: {
      h1: 'Caisse la plus rapide pour boulangers | Puissance i7 & 9 langues | Vysion',
      intro:
        "Mise en caisse pensée boulangerie : Intel i7 (« La Bête ») pour les pics du matin, 9 langues, propriété du matériel après 24 mois — le système de caisse Belgique et Pays-Bas.",
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'Encaissement et commandes rapides : matériel i7, 9 langues pour équipes multilingues, maîtrise des marges — la caisse horeca pour café, friterie, kebab et sandwicherie.',
      body1:
      ...
      body2:
        'Du snack au kebab : commandes, stock, paiements sous contrôle. Essayez gratuitement et sentez la puissance i7.',
    ...
    kapper: {
      ...
      intro:
        'Valorisez votre salon : caisse i7 pro, encaissement fluide, 9 langues, matériel à vous après 24 mois.',
      body1:
    ...
    retail: {
      h1: "Caisse retail & stocks | L'i7 « Bête » pour magasins | Vysion",
      intro:
        'Stocks sur i7 puissant (16 Go RAM), POS tactile et site intégré — caisse retail qui grandit avec vous.',
      body1:
    ...
    hardwarePlatform: {
      h1: 'Plateforme en ligne gratuite & matériel i7 | Offre Vysion',
      intro:
        'POS i7 haut de gamme, 44 vidéos, 9 langues, propriété du matériel après 24 mois — fini la location sans intérêt.',
      body1:
        'Commande en ligne, boutique web et caisse réunies. Acheter une caisse ou démarrer avec un abonnement clair — rapidité i7 + SSD.',
      body2:
  ...
  es: {
    breadcrumb: 'Sectores',
    bakkerij: {
      h1: 'TPV más rápido para panaderías | Potencia i7 y 9 idiomas | Vysion',
      intro:
        "Caja pensada para panadería: Intel i7 («La Bestia») para picos matutinos, 9 idiomas, hardware tuyo a los 24 meses — sistema de caja Bélgica y Países Bajos.",
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'Pedidos y cobro rápidos: hardware i7, 9 idiomas, control de márgenes — el TPV horeca para café, freiduría, kebab y bocadillería.',
      body1:
      ...
      body2:
        'Del bocadillo al kebab: pedidos, stock y pagos bajo control. Prueba gratis y nota la potencia i7.',
    ...
    kapper: {
      ...
      intro:
        'Mejora tu salón: TPV i7 profesional, cobro fluido, 9 idiomas, hardware tuyo a los 24 meses.',
      body1:
    ...
    retail: {
      ...
      intro:
        'Stock en i7 potente (16 GB RAM), TPV táctil e integración web — caja retail que crece contigo.',
      body1:
    ...
    hardwarePlatform: {
      h1: 'Plataforma online gratis y hardware TPV i7 | Oferta Vysion',
      intro:
        'TPV i7 de gama alta, 44 vídeos, 9 idiomas, propiedad a los 24 meses — deja de alquilar sin sentido.',
      body1:
        'Pedidos online, webshop y caja unificados. Comprar caja o empezar con plan claro — máxima velocidad con i7 y SSD.',
      body2:
  ...
  it: {
    breadcrumb: 'Settori',
    bakkerij: {
      h1: 'Cassa più veloce per panetterie | Potenza i7 e 9 lingue | Vysion',
      intro:
        "Layout cassa per panetteria: Intel i7 («La Bestia») per picchi mattutini, 9 lingue, hardware tuo dopo 24 mesi — sistema cassa Belgio e Paesi Bassi.",
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'Ordini e incassi veloci: hardware i7, 9 lingue per staff multilingue, controllo margini — cassa horeca per café, friggitoria, kebab e paninoteca.',
      body1:
      ...
      body2:
        'Dal panino al kebab: ordini, magazzino, pagamenti sotto controllo. Prova gratis e senti la potenza i7.',
    ...
    kapper: {
      ...
      intro:
        'Valore al salone: cassa i7 professionale, incasso fluido, 9 lingue, hardware tuo dopo 24 mesi.',
      body1:
    ...
    retail: {
      h1: "Cassa retail e scorte | L'i7 «Bestia» per negozi | Vysion",
      intro:
        'Scorte su i7 potente (16 GB RAM), POS touchscreen e integrazione web — cassa retail che scala con te.',
      body1:
    ...
    hardwarePlatform: {
      h1: 'Piattaforma online gratuita e hardware cassa i7 | Offerta Vysion',
      intro:
        'Cassa i7 top, 44 video, 9 lingue, proprietà hardware dopo 24 mesi — basta noleggi inutili.',
      body1:
        'Ordini online, webshop e cassa unificati. Comprare cassa o iniziare con piano chiaro — massima velocità con i7 e SSD.',
      body2:
  ...
  ja: {
    breadcrumb: '業種',
    bakkerij: {
      h1: 'ベーカリー向け最速POS｜i7パワー＆9言語｜Vysion',
      intro:
        'パン屋向けレジ構成：朝のピークに強いIntel i7（「The Beast」）、9言語、24か月後にハードがあなたのものに — ベルギー・オランダ向けPOS。',
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        '高速注文・会計：i7端末、多言語チーム向け9言語、粗利管理 — カフェ、揚げ物店、ケバブ、サンドイッチ向け。',
      body1:
        '深夜ラッシュも昼のピークも、カウンターは最速レジで。ソフト・ハード・オンライン注文を一体に — ベルギー向けPOSに最適。',
      body2:
        'サンドイッチからケバブまで、注文・在庫・決済を一元管理。無料トライアルでi7の速さを体感。',
    ...
    kapper: {
      ...
      intro:
        'サロンをアップグレード：プロ仕様のi7レジ、スムーズな会計、9言語、24か月後にハードはあなたのもの。',
      body1:
    ...
    retail: {
      h1: '小売POSと在庫｜店舗向けi7「ビースト」｜Vysion',
      intro:
        '高性能i7（16GB RAM）、タッチPOS、サイト連携で在庫管理 — 店とともに伸びるレジ。',
      body1:
    ...
    hardwarePlatform: {
      h1: '無料オンラインプラットフォーム＆i7レジハード｜Vysion特典',
      intro:
        'ハイエンドi7レジ、44本の動画ガイド、9言語、24か月後にハード所有 — 無意味なレンタルから脱却。',
      body1:
        'オンライン注文・ウェブショップ・レジを一体に。POS購入も明確なプランで開始 — i7とSSDの速さ。',
      body2:
  ...
  zh: {
    breadcrumb: '行业',
    bakkerij: {
      h1: '面包房最快收银｜i7 性能与 9 种语言｜Vysion',
      intro:
        '面向面包店的收银布局：Intel i7（“猛兽”）应对早高峰，9 种语言，24 个月后硬件归您 — 比利时与荷兰适用的收银系统。',
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        '快速点餐与结账：i7 设备、9 种语言服务多语团队、掌控毛利 — 面向咖啡馆、炸物店、烤肉和三明治吧。',
      body1:
        '夜宵或午高峰都需要最快收银。软硬件与在线订餐一体 — 适合比利时餐饮外卖与堂食。',
      body2:
        '从三明治到烤肉：订单、库存、收款一目了然。免费试用感受 i7 性能。',
    ...
    kapper: {
      ...
      intro:
        '升级沙龙：专业 i7 收银、顺畅收款、9 种语言，24 个月后硬件归您。',
      body1:
    ...
    retail: {
      ...
      intro:
        '以强劲 i7（8GB 内存）、触屏 POS 与网站集成管理库存 — 随店成长的零售收银。',
      body1:
    ...
    hardwarePlatform: {
      h1: '免费线上平台与 i7 收银硬件｜Vysion 方案',
      intro:
        '高端 i7 收银、44 条视频教程、9 种语言，24 个月后硬件归您 — 告别无意义的长期租用。',
      body1:
        '在线订餐、网店与收银一体。购买或以清晰套餐起步 — i7 与 SSD 带来最快速度。',
      body2:
  ...
  ar: {
    breadcrumb: 'القطاعات',
    bakkerij: {
      h1: 'أسرع نظام كاشير للمخابز | قوة i7 و9 لغات | Vysion',
      intro:
        'تخطيط كاشير للمخابز: Intel i7 («الوحش») لذروة الصباح، 9 لغات، وتصبح الأجهزة ملكك بعد 24 شهرًا — نظام كاشير بلجيكا وهولندا.',
      body1:
    ...
    horecaSnack: {
      ...
      intro:
        'طلبات ودفع سريعان: أجهزة i7، 9 لغات للطاقم متعدد اللغات، تحكم بالهامش — كاشير المطاعم للمقاهي والقلي والكباب والساندويتش.',
      body1:
        'زحام ليلي أو وقت الغداء: أسرع كاشير عند المنضدة. شراء كاشير مع برمجيات وأجهزة وطلبات أونلاين — نظام بلجيكا المثالي.',
      body2:
        'من الساندويتش إلى الكباب: طلبات ومخزون ومدفوعات تحت السيطرة. جرّب مجانًا واختبر قوة i7.',
    ...
    kapper: {
      ...
      intro:
        'طور صالونك: كاشير i7 احترافي، دفع سلس، 9 لغات، والأجهزة ملكك بعد 24 شهرًا.',
      body1:
    ...
    retail: {
      ...
      intro:
        'إدارة المخزون على i7 قوي (16 جيجابايت RAM) وPOS لمس وتكامل موقع — كاشير يتوسع مع متجرك.',
      body1:
    ...
    hardwarePlatform: {
      h1: 'منصة أونلاين مجانية وأجهزة كاشير i7 | عرض Vysion',
      intro:
        'كاشير i7 راقٍ، 44 فيديو تعليميًا، 9 لغات، وامتلاك الأجهزة بعد 24 شهرًا — توقف عن الإيجار بلا فائدة.',
      body1:
        'طلبات أونلاين ومتجر ويب وكاشير في منظومة واحدة. شراء كاشير أو البدء بباقة واضحة — أقصى سرعة مع i7 وSSD.',
      body2:
